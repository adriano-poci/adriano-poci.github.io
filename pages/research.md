...
<a href="{{ BASE_PATH }}/assets/plMlMl.png"><img src="{{ BASE_PATH }}/assets/plMlMl.png" style="float: left; width: 40%; margin-right: 1%; margin-bottom: 0.5em;" /></a>
<a href="{{ BASE_PATH }}/assets/cappMlMlb.png"><img src="{{ BASE_PATH }}/assets/cappMlMlb.png" style="float: left; width: 33%; margin-right: 1%; margin-top: 0.5em; margin-bottom: 1.0em; background-color: white" /></a>
