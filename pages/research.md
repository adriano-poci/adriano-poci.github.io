...
<p>These total-mass density slopes were also found to correlate with a number of other physical properties of galaxies. the strongest such correlation was found to be with the central velocity dispersion (within <MATH>1 R<sub>e</sub></MATH>), <MATH> &sigma;<sub>e</sub></MATH>, illustrated here. This correlation is interesting because it shows a clear transition at <MATH> <mrow><msub><mi>log</mi><mn>10</mn></msub><mo>&#x2061;<!--FUNCTION APPLICATION--></mo>(<mi>&sigma;<sub>e</sub></mi>)</mrow></MATH>.
