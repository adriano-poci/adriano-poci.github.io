...
<div class="resGrid">
    ...
    <div class="grid-row" style="grid-column: 1; grid-row: 2;"><a href="{{ BASE_PATH }}/assets/lensmods.png" title="lensKin"><img src="{{ BASE_PATH }}/assets/lensmods.png" style="width:300px;" /></a></div>
