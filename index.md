...
<div class="grid-container">
    <div class="grid-row" style="grid-column: 2; grid-row: 1;">Adriano Poci</div>
    ...
    <div class="grid-row" style="grid-column: 1; grid-row: 2; text-align: right;">Macquarie University</div>
